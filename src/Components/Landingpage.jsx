...
function Landingpage() {
  return (
    ...
    <div className="container-fluid" id='landingpage'>  
            <h1 className='p-3 fw-bolder'>Bring top talent to your business, your way</h1>
  ...
  <h1 class="display-4">The #1 Job Site to Find Remote Jobs-No Ads, Scams, or Junk</h1>
        ...
        <h3 className='mb-2'>Unlimited Job Search Resources</h3>
            ...
            <h3 className='mb-2'>Higher Quality Listings
            </h3>
